...
//     // Get AI response
//     GeminiService.sendMessage(text).then((response) {
//       setState(() {
...
//                   // Use the styled message widgets
//                   if (isUser) {
...
//             ),
//           ],
import 'package:chat_app/constants/jumpingloadingindictor.dart';
                  ...
                  Expanded(
                    child: StreamBuilder<List<AiMessage>>(
                      ...
                      builder: (context, snapshot) {
                        ...
                        // If we get fresh data from Firestore, use it
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            // Adjust index for messages when showing typing indicator
