...
//       body: Column(
//         children: [
//           // Top container with background shape
//           Container(
//             height: size.height * .65,
//             width: double.infinity,
//             decoration: BoxDecoration(
//               color: const Color(0xff393a4c),
//               borderRadius: BorderRadius.only(
//                 bottomLeft: Radius.circular(size.width * 0.7),
//                 bottomRight: Radius.circular(size.width * 0.7),
//               ),
//             ),
//             child: Container(
...
//                 borderRadius: BorderRadius.only(
//                   bottomLeft: Radius.circular(size.width * 0.55),
//                   bottomRight: Radius.circular(size.width * 0.55),
//                 ),
//               ),
...
//       currentIndex = index;
//     });
//     _startAutoSlide(); // reset timer when swiped
//   },
...
//   child: CustomElevatedButton(text: "Get started", onPress: () {}),
// ),
